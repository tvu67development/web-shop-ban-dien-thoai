	...
	<div id="logreg-forms">
		...
		<form action="signup" method="post" class="form-signup">
			...
			<input name="address" type="text"
				id="user-name" class="form-control" placeholder="Address..."
				required autofocus=""> 
			<input name="phone" type="text"
				id="user-name" class="form-control" placeholder="Your phone..."
				required autofocus=""> 
			<input name="user" type="text"
				id="user-name" class="form-control" placeholder="User mail"
				required="" autofocus=""> 
			<input name="pass" type="password"
				id="user-pass" class="form-control" placeholder="Password" required
				autofocus=""> 
			<input name="repass" type="password"
				id="user-repeatpass" class="form-control"
