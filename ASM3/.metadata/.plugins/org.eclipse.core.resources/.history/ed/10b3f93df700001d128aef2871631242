...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<!-- Kết quả trả về từ DAO là một list và không bao giờ null. Vì nếu null sẽ có Exception -->
			<c:choose>
				<c:when test="${listP.size() == 0}">
					<p class="text-danger font-weight-bold font-italic">
									...
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="row">
												...
												<div class="col">
													<a href="cart?pid=${o.id}&action=add"
